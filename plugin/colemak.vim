...
" }}}
" Up/down/left/right {{{
    nnoremap n h|xnoremap n h|onoremap h n|
    nnoremap e j|xnoremap e j|onoremap n e|
    nnoremap i k|xnoremap i k|onoremap e i|
    nnoremap o l|xnoremap o l|onoremap i o|
